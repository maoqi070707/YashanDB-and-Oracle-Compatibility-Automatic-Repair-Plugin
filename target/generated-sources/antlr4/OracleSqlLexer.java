...
public class OracleSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DELETE", "CREATE", "TABLE", "DROP", "ALTER", "ADD", "COMMIT", "ROLLBACK", 
			"AS", "NOT", "NULL", "AND", "OR", "VARCHAR2", "NUMBER", "DATE", "TIMESTAMP", 
			"LPAREN", "RPAREN", "COMMA", "PLUS", "MINUS", "MULT", "DIV", "EQUALS", 
			"NOT_EQUALS", "LESS_THAN", "GREATER_THAN", "LESS_EQUALS", "GREATER_EQUALS", 
			"STRING", "NUMERIC_LITERAL", "DATE_LITERAL", "IDENTIFIER", "WS", "DIGIT", 
			"DATE_FORMAT"
		};
	}
